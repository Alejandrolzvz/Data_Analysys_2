...
# -*- coding: utf-8 -*-
"""
Created on Thu Mar  4 23:53:12 2021
...
# Run it in Console first:
# conda install -c anaconda py-xgboost

# EDA and Prediction

# Churn is a one of the biggest problem in  the telecom industry. 
# Research has shown that the average monthly churn rate among the 
# top 4 wireless carriers in the US is 1.9% - 2%. 
...
# **Let us read the data file in the python script**

telecom_cust = pd.read_csv('churning.csv')
...
# About 50% of the customers have a partner, while only 30% of the total 
...
# **What would be interesting is to look at the % of customers, who have 
# partners, also have dependents. We will explore this next. **

# Interestingly,  among the customers who have a partner, only about 
# half of them also have a dependent, while other half do not have any 
# independents. 
# Additionally, as expected, among the customers who do not have any 
# partner, a majority (80%) of them do not have any dependents .
...
# -------------------------------------------------------------------------
# I also looked at any differences between the % of customers with/without 
# dependents and partners by gender. There is no difference in their 
# distribution by gender. Additionally, there is no difference in senior 
# citizen status by gender.
...
# Interestingly most of the monthly contracts last for 1-2 months, while the 
# 2 year contracts tend to last for about 70 months. This shows that the 
# customers taking a longer contract are more loyal to the company and 
# tend to stay with it for a longer period of time. 

# This is also what we saw in the earlier chart on correlation with the 
# churn rate. 


# ---------------------------------------------------------------------

###  C. Let us now look at the distribution of various services used by 
# customers
...
# In our data, 74% of the customers do not churn. Clearly the data is 
# skewed as we would expect a large majority of the customers to not churn. 
# This is important to keep in mind for our modelling as skeweness could 
# lead to a lot of false negatives. We will see in the modelling section on 
# how to avoid skewness in the data.

# 2. Lets now explore the churn rate by tenure, seniority, contract type, 
# monthly charges and total charges to see how it varies by these variables.

# ** i.) Churn vs Tenure**: As we can see form the below plot, the customers 
# who do not churn, they tend to stay for a longer tenure with the telecom 
# company. 

sns.boxplot(x = telecom_cust.Churn, y = telecom_cust.tenure)

# ** ii.) Churn by Contract Type**: Similar to what we saw in the correlation 
# plot, the customers who have a month to month contract have a very high 
# churn rate.
...
# ** v.) Churn by Total Charges**: It seems that there is higer churn when 
...
# We will develop Logistic Regression, Random Forest, SVM, ADA Boost 
# and XG Boost
...
# * The results from random forest are very similar to that of the logistic 
# regression and in line to what we had expected from our EDA
