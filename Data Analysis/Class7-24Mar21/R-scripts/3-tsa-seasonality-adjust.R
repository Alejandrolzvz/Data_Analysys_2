...
# covid-19 confirmed Seasonally Adjusting
confirmedtimeseriesseasonallyadjusted <- confirmedtimeseries - confirmedtimeseriescomponents$seasonal
plot(confirmedtimeseriesseasonallyadjusted)
...
# Rain fall Seasonally Adjusting
raintimeseriesseasonallyadjusted <- raintimeseries - raintimeseriescomponents$seasonal
plot(raintimeseriesseasonallyadjusted)
...
skirts
skirtstimeseries <- ts(skirts,start=c(1866), frequency = 12)
skirtstimeseries
plot(skirtstimeseries)

# Decomposing the skirts time series
skirtstimeseriescomponents <- decompose(skirtstimeseries)
skirtstimeseriescomponents$seasonal
plot(skirtstimeseriescomponents)

# Skirts Seasonally Adjusting
skirtstimeseriesseasonallyadjusted <- skirtstimeseries - skirtstimeseriescomponents$seasonal
plot(skirtstimeseriesseasonallyadjusted)
